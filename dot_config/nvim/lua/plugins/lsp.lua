local setup_lsp_keymaps = function()
  vim.keymap.set('n', '<leader>d', vim.diagnostics.open_float)
  vim.keymap.set('n', '[d', vim.diagnostics.goto_prev)
  vim.keymap.set('n', ']d', vim.diagnostics.goto_next)
  vim.keymap.set('n', '<leader>q', vim.diagnostics.set_loclist)
...
local lsp_config = {
  ...
  config = function()
    ...
    lspconfig.tsserver.setup({
      on_attach = function() error('ts') end,
    ...
    lspconfig.lua_ls.setup({
      ...
      on_attach = on_attach,
      capabilities = cmp_capabilities,
      -- root_dir = lspconfig.util.root_pattern('init.lua', 'init.lua')
    })
